...
CREATE TEMPORARY TABLE MR_PROTOCOL (
...
REPLACE
into table RPConnectDB.MR_PROTOCOL
...
SELECT element
FROM RPConnectDB.MR_PROTOCOL
WHERE name = 'ProtocolName';
update MR_TABLE set MR_TABLE.Manufacturer =
(select element FROM RPConnectDB.MR_PROTOCOL
